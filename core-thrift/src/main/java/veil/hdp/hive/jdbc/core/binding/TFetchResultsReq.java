...
public class TFetchResultsReq implements org.apache.thrift.TBase<TFetchResultsReq, TFetchResultsReq._Fields>, java.io.Serializable, Cloneable, Comparable<TFetchResultsReq> {
  ...
  public TFetchResultsReq() {
    this.orientation = veil.hdp.hive.jdbc.core.binding.TFetchOrientation.FETCH_NEXT;
        ...
        switch (schemeField.id) {
          ...
          case 2: // ORIENTATION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.orientation = veil.hdp.hive.jdbc.core.binding.TFetchOrientation.findByValue(iprot.readI32());
