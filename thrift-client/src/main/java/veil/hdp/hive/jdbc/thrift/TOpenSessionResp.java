...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2017-05-01")
public class TOpenSessionResp implements org.apache.thrift.TBase<TOpenSessionResp, TOpenSessionResp._Fields>, java.io.Serializable, Cloneable, Comparable<TOpenSessionResp> {
  ...
  public TOpenSessionResp() {
    this.serverProtocolVersion = veil.hdp.hive.jdbc.thrift.TProtocolVersion.HIVE_CLI_SERVICE_PROTOCOL_V10;
        ...
        switch (schemeField.id) {
          ...
          case 2: // SERVER_PROTOCOL_VERSION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.serverProtocolVersion = veil.hdp.hive.jdbc.thrift.TProtocolVersion.findByValue(iprot.readI32());
