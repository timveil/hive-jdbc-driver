...
public class TOperationHandle implements org.apache.thrift.TBase<TOperationHandle, TOperationHandle._Fields>, java.io.Serializable, Cloneable, Comparable<TOperationHandle> {
  ...
  public void validate() throws TException {
    ...
    if (!isSetOperationId()) {
      throw new TProtocolException("Required field 'operationId' is unset! Struct:" + toString());
    }

    if (!isSetOperationType()) {
      throw new TProtocolException("Required field 'operationType' is unset! Struct:" + toString());
    }

    if (!isSetHasResultSet()) {
      throw new TProtocolException("Required field 'hasResultSet' is unset! Struct:" + toString());
    }
  ...
  private static class TOperationHandleStandardScheme extends StandardScheme<TOperationHandle> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TOperationHandle struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOperationHandle struct) throws TException {
      struct.validate();
  ...
  private static class TOperationHandleTupleScheme extends TupleScheme<TOperationHandle> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TOperationHandle struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TOperationHandle struct) throws TException {
