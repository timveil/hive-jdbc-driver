...
The Thrift Protocol Version or `TProtocolVersion` is defined in the `TCLIService.thrift` file and allows interoperability between different Hive versions.  It is important that the value you specify is supported by your version of HS2.  The default value, `7`, will work with Hive 1.2.0 or greater.  If you specify a value greater than supported by your HS2, you may get an exception with the following message: `Required field 'client_protocol' is unset!`.
